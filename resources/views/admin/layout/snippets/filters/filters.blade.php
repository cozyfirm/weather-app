<div class="jumbotron d-print-none" style="padding: 1em 1em;">
        ...
        <div class="col-md-6 text-right">
            <div class="col-md-12 mb-3">
                ...
                <select form="filter-form"
                        class="form-control form-control-sm col-md-2 d-inline-block"
                        name="limit"
                        onchange="this.form.submit()">
                    @foreach([15, 25, 50, 100, 200, 500, $var->total()] as $k)
